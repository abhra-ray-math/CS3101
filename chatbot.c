...
FAQ faq_list[max_res] = {
    ...
    {{"maximum books that can be borrowed","max", "maximum", "limit", "book count", "how many books can","copies", "availability", "stock", "books available"}, "You can borrow up to 5 books at a time. Faculty may have special privileges.Books with less than 3 copies are prioritized for faculty members. \n"},
    ...
    {{"how are you doing?","how about you"}, "I am doing great! How may I help you today?\n"},
    {{"what is your favourite book"},"I loved reading 'To Kill a Mockingbird' by Harper Lee.\n"},
    {{"how many books do"}, "There are 2900 books in the library.\n"},
    {{"i am doing fine","how about you"}, "I am also doing great! How may I help you today?\n"},
